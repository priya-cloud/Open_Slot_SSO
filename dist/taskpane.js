...
/* harmony export */ });
/* harmony import */ var office_addin_sso__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! office-addin-sso */ "./node_modules/office-addin-sso/lib/main.js");
/* harmony import */ var office_addin_sso__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(office_addin_sso__WEBPACK_IMPORTED_MODULE_0__);
...
function dialogFallback(callback) {
  callbackFunction = callback; // We fall back to Dialog API for any error.
...
function _processMessage() {
  _processMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(arg) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            loginDialog.close();
            _context.next = 6;
            return office_addin_sso__WEBPACK_IMPORTED_MODULE_0__.makeGraphApiCall(messageFromDialog.result);
          ...
          case 10:
            if (messageFromDialog.error === undefined && messageFromDialog.result.errorCode === undefined) {// Need to pick the user to use to auth
            } else {
              // Something went wrong with authentication or the authorization of the web application.
              loginDialog.close();

              if (messageFromDialog.error) {
                office_addin_sso__WEBPACK_IMPORTED_MODULE_0__.showMessage(JSON.stringify(messageFromDialog.error.toString()));
              }
            }
...
/* harmony export */ });
/* harmony import */ var _fallbackauthhelper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fallbackauthhelper */ "./src/helpers/fallbackauthhelper.js");
/* harmony import */ var office_addin_sso__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! office-addin-sso */ "./node_modules/office-addin-sso/lib/main.js");
/* harmony import */ var office_addin_sso__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(office_addin_sso__WEBPACK_IMPORTED_MODULE_1__);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function getGraphData(_x) {
  return _getGraphData.apply(this, arguments);
}

function _getGraphData() {
  _getGraphData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(callback) {
    var bootstrapToken, response, mfaBootstrapToken;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 3:
            ...
            _context.next = 6;
            return office_addin_sso__WEBPACK_IMPORTED_MODULE_1__.makeGraphApiCall(bootstrapToken);
          ...
          case 10:
            ...
            response = office_addin_sso__WEBPACK_IMPORTED_MODULE_1__.makeGraphApiCall(mfaBootstrapToken);
          ...
          case 15:
            ...
            if (_context.t0.code) {
              if (office_addin_sso__WEBPACK_IMPORTED_MODULE_1__.handleClientSideErrors(_context.t0)) {
                (0,_fallbackauthhelper__WEBPACK_IMPORTED_MODULE_0__.dialogFallback)(callback);
              }
            } else {
              office_addin_sso__WEBPACK_IMPORTED_MODULE_1__.showMessage("EXCEPTION: " + JSON.stringify(_context.t0));
              Promise.reject();
            }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.makeGraphApiCall = void 0;
const message_helper_1 = __webpack_require__(/*! ./message-helper */ "./node_modules/office-addin-sso/lib/message-helper.js");
const $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
function makeGraphApiCall(bootstrapToken) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            (0, message_helper_1.showMessage)(`Error from Microsoft Graph. \n${err}`);
        }
    });
}
...
/* harmony export */ });
/* harmony import */ var _helpers_ssoauthhelper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../helpers/ssoauthhelper */ "./src/helpers/ssoauthhelper.js");
  ...
  _run = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            (0,_helpers_ssoauthhelper__WEBPACK_IMPORTED_MODULE_0__.getGraphData)(writeDataToOfficeDocument);
...
function writeDataToOfficeDocument(result) {
  ...
  var userInfo = "";
  userInfo = "Start: " + result.value[0].scheduleItems[0].start.dateTime + "End: " + result.value[0].scheduleItems[0].end.dateTime;
